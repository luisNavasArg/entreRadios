...
<html>
<head>
<title>Consultar declaraciones</title>
<meta charset="utf-8" />
<style type="text/css">
*{
    font-size: 14px;
...
<body>
<form action="mover_declaracion.php" method="post"  class="guardar">
<div><label>Nombre del usuario: </label><?php $obj->consultarDeclaraciones(); ?></div>
